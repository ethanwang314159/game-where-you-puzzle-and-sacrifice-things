...
@export var NOISE_SWAY_SPEED: float = 0.5
# Noise returns values in the range (-1, 1)
# So this is how much to multiply the returned value by
@export var NOISE_SHAKE_STRENGTH: float = 12.0
@export var NOISE_SWAY_STRENGTH: float = 8.0
...
func apply_noise_shake(strength : float) -> void:
...
func _on_health_comp_die():
	apply_noise_shake(16)
